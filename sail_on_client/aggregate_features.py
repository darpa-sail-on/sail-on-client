...
def cmd_opts() -> Namespace:
    ...
    """
    parser = argparse.ArgumentParser("Aggregate features generated by the client. Note: The script only supports aggregation for the top level keys.")
    parser.add_argument("--feature-paths", nargs="+", help="Path to feature files that would be aggregated")
...
def main() -> None:
    ...
    features = list(map(lambda feature_path: pkl.load(open(feature_path, "rb")), feature_paths))
